...
namespace App2.Component
{
    ...
    public class VinSelectDialog
    {
        ...
        public string Vin => _autoCompleteText.Text;
        ...
        public VinSelectDialog(Activity activity,string title,string vin = null,string selectedNote = null)
        {
            _title = title;
            _activity = activity;
        ...
        {
            AddAutocompleteToLayout(autocomplete, Android.Resource.Layout.SimpleDropDownItem1Line, "VIN");
